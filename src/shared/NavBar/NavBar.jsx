...
const NavBar = () => {
  ...
  const navItems = (
    <div className="flex flex-col items-center justify-center gap-6 py-24 my-6 lg:flex-row lg:my-0 md:py-36 lg:py-0">
      <NavLink
  ...
  return (
    <div className="fixed z-10 w-full text-white">
      <div className={`mx-auto ${scrolled ? "text-black" : ""}`}>
                    ...
                    <div className="dropdown dropdown-end">
                      ...
                      >
                        ...
                        <Link
                          ...
                          to="/dashboard"
                        >
                          <button className="text-center text-lg px-2.5 pb-1 flex justify-center items-center gap-1">
                            <MdOutlineDashboard />
                            Dashboard
                          </button>
                        </Link>
