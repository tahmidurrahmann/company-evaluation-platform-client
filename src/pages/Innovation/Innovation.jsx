  ...
  return (
    <div className="space-y-6 mb-24">
      ...
      <div className="max-w-screen-2xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 px-4 xl:px-0 my-12">
          {service.map((item) => (
            // <div
            //   key={item._id}
            ...
            //       <h2 className="card-title">0{item?._id}.{item.title}</h2>
            //       <p>{item.subtitle}</p>
            //     </div>
            ...
            <div key={item?._id} className="block">
              ...
              <h3 className="mt-4 text-lg font-bold text-gray-900 sm:text-xl">0{item?._id}.{item.title}</h3>
        ...
        <div className="mt-10">
          ...
          <div className="flex justify-center items-center mt-24">
            <div>
              ...
              <div className="grid gap-14 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center mx-auto justify-center px-4 xl:px-0">
                <div className="w-full bg-base-100 shadow-xl flex justify-center items-center lg:h-[200px] ">
                  ...
                  <div className="card-body">
                    <h2 className="card-title text-base md:text-xl">01. Innovative Solutions</h2>
                    <p>
                ...
                <div className="w-full bg-base-100 shadow-xl flex justify-center items-center lg:h-[200px]">
                  ...
                  <div className="card-body">
                    <h2 className="card-title text-base md:text-xl">02. Client-Centric Approach</h2>
                    <p>
                ...
                <div className="w-full bg-base-100 shadow-xl flex justify-center items-center lg:h-[200px]">
                  ...
                  <div className="card-body">
                    <h2 className="card-title text-base md:text-xl">03. Proven Track Record</h2>
                    <p>
