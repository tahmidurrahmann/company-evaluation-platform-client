    ...
    return (
        <div>
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center max-w-screen-xl mx-auto">
                <div className="ml-10 space-y-6" data-aos="fade-up"
            ...
            <div className="mt-20 flex justify-center items-center" data-aos="fade-up"
                data-aos-duration="2000">
            ...
            <div className="grid mt-16 max-w-screen-xl mx-auto lg:grid-cols-4 gap-5 md:grid-cols-2 grid-cols-1 mb-10  justify-evenly">
                <div className="bg-base m-12 lg:ml-0 p-6 rounded-xl shadow-gray-400 hover:shadow-blue-500 shadow-xl" data-aos="fade-up"
                    data-aos-duration="2000">
            ...
            <div className="mt-52 max-w-screen-xl mx-auto flex flex-col lg:flex-row justify-between" >
                ...
                <div className="space-y-3 lg:mt-0 lg:text-start text-center mt-12" data-aos="fade-up"
                    data-aos-duration="2000">
            ...
            {/* five section here*/}
            <div className="bg-shadow-700 bg-gray-100 rounded-t-full shadow-2xl hover:shadow-blue -500  h-[50vh]    mt-32" data-aos="fade-up"
