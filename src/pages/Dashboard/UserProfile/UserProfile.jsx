        ...
        <div>
            <div className="overflow-x-auto ">
                {employeeRequestCheck?.status === "checked" ?
                    ...
                    <div className="card  mt-12 h-[200px] hover:border-red-400 card-side bg-transparent shadow-xl animate-border boder-blue-300 border-l-2  border-r-2">
                        <figure>
                        ...
                        <div className="card-body">
                            ...
                            <div className=" flex  items-center  justify-end">
                                <PopupButton
                                    ...
                                    className="bg-black hover:bg-black border-b-2  py-3 px-8 rounded-s-lg rounded-t-sm transition hover:scale-105 text-white font-medium"
