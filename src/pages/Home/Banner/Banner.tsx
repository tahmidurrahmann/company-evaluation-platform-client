      ...
      <div className="absolute top-0 bg-gradient-to-r from-[#15151500] to-[#151515] w-full h-full">
        <div className="absolute top-0 bg-gradient-to-r from-[#15151500] to-[#151515] w-full h-full">
          <div className="absolute flex flex-col items-center justify-center space-y-4 transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 lg:space-y-4 xl:space-y-10">
            <h1 className="font-semibold text-center text-white md:text-4xl">
              Boost Your IT <span className="text-[#007cc7]">Skills</span> with
              Accurate <span className="text-[#007cc7]">Assessments</span>
            </h1>
              <p className="text-sm text-center text-white hidden md:flex">
            ...
            <div className="flex items-center justify-center">
              <span
                onClick={openModal}
                className="font-semibold bg-[#007cc7] px-2 md:px-5 py-1 md:py-2 rounded-md text-xs md:text-base text-white hover:scale-105 transition flex justify-center items-center gap-4"
              >
