...
const About_valus = () => {
    return (
        <div className="mb-20">
          <div className="">
                <h1 className="font-bold text-2xl ml-16  mb-2 uppercase">OUR VALUES</h1>
                <h1 className="text-5xl ml-16 mb-12 font-bold">Completely disintermediate <br /><span className="text-[#007cc7] ">excellent skills</span></h1>
          </div>
          <div className="grid mt-9 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 max-w-screen-xl mx-auto">
