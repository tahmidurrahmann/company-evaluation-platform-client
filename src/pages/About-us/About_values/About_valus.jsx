    ...
    return (
        <div className="mb-20 max-w-screen-xl mx-auto">
          ...
          <div className="grid mt-9 lg:grid-cols-3 gap-6 md:grid-cols-2 grid-cols-1">
            <div>
                {/* 1 hellow */}
                    <div className="bg-base-100 shadow-2xl hover:shadow-blue-500 lg:w-96 w-80 ml-12 lg:ml-0 h-80 rounded-xl" data-aos="zoom-in-right" data-aos-duration="1000">
            ...
            <div>
                {/* 2 hellow */}
                    <div className="bg-base-100 shadow-2xl lg:w-96 w-80 ml-12 lg:ml-0 hover:shadow-blue-500 h-80 rounded-xl" data-aos="zoom-in-right" data-aos-duration="2000">
