...
const GlobalCollection = () => {
  return (
    <div className="mt-10  md:mt-32 lg:mt-40 px-4 2xl:px-0 max-w-screen-xl mx-auto">
      ...
      <div className="flex lg:flex-row flex-col gap-10  ">
        <div className="">
          ...
          <div>
            ...
            <Link className="btn px-8  mb-20 hover:bg-blue-300" onClick={() => document.getElementById('my_modal_1').showModal()}>Lets more</Link>
